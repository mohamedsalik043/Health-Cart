   ...
   if(mysqli_num_rows($cart_query) > 0){
      while($product_item = mysqli_fetch_assoc($cart_query)){
         ...
         $price_total += $product_price;
          ...
          $product_name_db = $product_item['name'];
          $quantity_purchased = $product_item['quantity'];
 
          $update_stock_query = mysqli_query($conn, "UPDATE `products` SET stock = stock - $quantity_purchased WHERE name = '$product_name_db'");
      };
   };
...
<section class="checkout-form">
   ...
   <div class="display-order">
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            <span>city</span>
            <input type="text" placeholder="e.g. Virudhunagar" name="city" required>
         </div>
         <div class="inputBox">
            <span>state</span>
            <input type="text" placeholder="e.g. Tamilnadu" name="state" required>
         </div>
         <div class="inputBox">
            <span>country</span>
